# MicroPython SSD1306 OLED driver, I2C and SPI interfaces  ALS Mod version
...
# ALS mod to period to center it up
...
def E(x, y, oled, font_size=2, fill=1):
    ...
    oled.line(int(x + font_size * 1),int(y + font_size * 15),int(x + font_size * 1),int(y + font_size * 1),fill) #vert stroke
    oled.line(int(x + font_size * 1),int(y + font_size * 1),int(x + font_size * 9),int(y + font_size * 1),fill)  #top stroke
    oled.line(int(x + font_size * 1),int(y + font_size * 7),int(x + font_size * 7),int(y + font_size * 7),fill) #mid stroke
    oled.line(int(x + font_size * 1),int(y + font_size * 15),int(x + font_size * 9),int(y + font_size * 15),fill) #bot stroke
...
def P(x, y, oled, font_size=2, fill=1):
    ...
    oled.line(int(x + font_size * 9),int(y + font_size * 6), int(x + font_size * 6),int(y + font_size * 9),fill) # added int
...
def period(x, y, oled, font_size=2, fill=1):
    ...
    oled.line(int(x + font_size * 4),int(y + font_size * 14),int(x + font_size * 6),int(y + font_size * 14),fill) #adjusted the x coord of the period
    oled.line(int(x + font_size * 4),int(y + font_size * 15),int(x + font_size * 6),int(y + font_size * 15),fill) #from 1 and 3 to 4 and 6 for taste
